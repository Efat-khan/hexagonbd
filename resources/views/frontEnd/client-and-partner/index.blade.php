...
<div class="page-header title-area">
    <div class="header-title" style="background:url({{asset('images/bg/page-header1.jpg')}})">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-title">Clients and Partners</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <nav class="breadcrumb"><span>
                        ...
                        <span><span>Clients and Partners</span></span>
                    </nav>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-3">
                <div class="fp-team">
                    <div class="team-member">
                        <img src="{{ asset($client->image??'/images/default/management.png') }}" alt="" class="team-img">
                        <div class="phone">
                            <i class="factory-technology"></i>
                            <div class="number">{{$client->phone??'N/A'}}</div>
                        </div>
                    </div>

                    <div class="info">
                        <h4 class="name">{{ $client->company_name }}</h4>
                        <span class="job">{{ $client->email??'' }}</span>

                        <p class="message">
                            <span class="short-text">
                                {!! \Illuminate\Support\Str::limit($client->description, 300, '...') !!}
                            </span>
                            <span class="full-text" style="display:none;">
                                {!! $client->description !!}
                            </span>
                        </p>
                        @if(strlen($client->description) > 200)
